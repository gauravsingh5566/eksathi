    ...
    onSubmit: async (values, action) => {
      ...
      try {
        ...
        // } else {
          ...
          const res = await api.post(`app/auth/forget-password`, {
            ...values,
            type: type,
          });
          console.log(res);
                  ...
                  <div className="form-action-wrapper py-5">
                    <div className="form-group">
                      ...
                      <p className="pt-3">
                        ...
                        into your Account? Don't worry, we'll help you to get
                        back your account. Enter your email address and we'll
                        send you a recovery link to reset your password.
                      </p>
                    </div>
                    <div className="form-group">
