...
const GetStarted = () => {
  return (
    <section className="get-started-area pt-5 pb-0">
      <div className="container">
        <div className="row">
          <div className="col-lg-6 responsive-column-half">
            <div className="media media-card align-items-center shadow rounded-4">
              <div className="mx-4">
                <svg
                  aria-hidden="true"
              ...
              <div className="media-body">
                <p className="pb-3 fs-18">
                  Find the best answer to your technical question, <br /> help
                  others answer theirs
                </p>
                <a href="/questions" className="">
                  Browse questions <i className="la la-arrow-right icon ml-1" />
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-6 responsive-column-half">
            <div className="media media-card align-items-center shadow rounded-4">
              ...
              {/* <div className="media-body">
                <p className="pb-3 fs-18">
                  Want a secure, private space for your <br /> technical
                  knowledge?
                </p>
                <a
                  href="free-demo.html"
              ...
              <div className="media-body">
                <p className="pb-3 fs-17">
                  World's Only dedicated platform for teachers to,  <br />  search job Professionals to deliver online/offline lecturs.
                </p>
                <a
                  href="/careers"
                  className=""
