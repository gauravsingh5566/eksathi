          ...
          <div className="col-lg-5">
            <div className="info-box text-center">
              ...
              <div className="info-body">
                <h5 className="pb-4 fs-28 fw-bold">
                ...
                <a href="talent.html" className="btn theme-btn">
                  EkSathi Talent <i className="la la-arrow-right icon ml-1" />
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-5">
            <div className="info-box text-center">
              ...
              <div className="info-body">
                ...
                <a href="advertising.html" className="btn theme-btn">
                  EkSathi Advertising{" "}
