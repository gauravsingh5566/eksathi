import { Avatar, Box, Button, Chip, Grid, IconButton } from "@mui/joy";
...
const InstituteCard = ({ onlyShow }) => {
  // const [Institutedata, setInstitutedata] = useState(Institute);
  ...
  const getInstitutes = async () => {
    try {
      ...
      console.log("Institutes", response?.data?.result);
  ...
  return (
    <>
      <div className="col  mb-3">
        <Grid container gap={3} className="mt-2 mb-2 ">
          {onlyShow
            ? institutes.slice(0, onlyShow).map((data, index) => (
                <div key={index}>
                  <Card
                    key={index}
                    sx={{
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography level="title-lg fw-bold">
                        {data?.name}
                      </Typography>
                    ...
                    <CardOverflow sx={{ bgcolor: "background.level1" }}>
                      <Box className=" p-1 d-flex align-items-center justify-content-center mt-1 mb-1">
                        <Button className="" variant="outlined" color="neutral">
                          Message
                        </Button>{" "}
                        &nbsp;
