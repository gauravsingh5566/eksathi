...
const CallToAction = () => {
  return (
    <section
      className="get-started-area py-5 pattern-bg"
      id="for-developers"
    >
      <div className="container">
        <div className="text-center">
          <h2 className="section-title pb-3">For Students, by Teachers</h2>
          <p className="section-desc w-50 mx-auto">
            EkSathi is an open community for anyone who is Student or a Teacher. We help you get answers to your toughest questions, share knowledge with subject matter Gyani's.
          </p>
        </div>
        <div className="row pt-50px">
          <div className="col-lg-4 responsive-column-half">
            <div className="card card-item hover-y text-center rounded shadow">
              <div className="card-body">
                ...
                <p className="card-text pb-4">
                  Get Answers for the question in your mind by Experts.
                  Share your knowledge and become subject matter expert.
                </p>
              </div>
              {/* end card-body */}
            </div>
          ...
          <div className="col-lg-4 responsive-column-half">
            <div className="card card-item hover-y text-center rounded shadow">
              <div className="card-body">
                ...
                <p className="card-text pb-4">
                  Our AI system will recommend you expert based on Question asked.
                  Discuss and Get Associated as an research collaborator.
                </p>
              </div>
              {/* end card-body */}
            </div>
          ...
          <div className="col-lg-4 responsive-column-half">
            <div className="card card-item hover-y text-center rounded shadow">
              <div className="card-body">
                ...
                <p className="card-text pb-4">
                Looking for Part Time, Full Time or Guest Lecturer Jobs, Eksathi is with you. Specially dedicated jobs only for Teachers.
                </p>
              </div>
              {/* end card-body */}
            </div>
