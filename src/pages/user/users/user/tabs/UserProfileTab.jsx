    ...
    return (
        <div className="user-panel-main-bar">
            ...
            <div className="user-panel mb-30px pt-30px border-top border-top-gray">
                <ul className="generic-list-item fs-2 row row-cols-1 row-cols-md-2 row-cols-lg-3 gap-2">
                    <li className="pl-3 border py-2 rounded">
                        <i class="bi bi-globe2 pr-2 text-primary"></i>
                        <a href={user?.website} target="_blank" className="d-inline-block">
                            {/* {user?.website} */}
                            Website
                        </a>
                    </li>
                    {
                        user?.fb ?
                            <li className="pl-3 border py-2 rounded">
                                <a href={user.fb} className="d-inline-block">
                                    <i class="bi bi-facebook text-primary pr-2"></i>
                                    Facebook
                                </a>
                            </li> : null
                    }
                    {
                        user?.twitter ?
                            <li className="pl-3 border py-2 rounded">
                                <a href={user.twitter} className="d-inline-block">
                                    <i class="bi bi-twitter text-primary pr-2"></i>
                                    Twitter
                                </a>
                            </li> : null
                    }
                    {
                        user?.insta ?
                            <li className="pl-3 border py-2 rounded">
                                <a href={user.insta} className="d-inline-block">
                                    <i class="bi bi-instagram text-primary pr-2"></i>
                                    Instagram
                                </a>
                            </li> : null
                    }
                    {
                        user?.github ?
                            <li className="pl-3 border py-2 rounded">
                                <a href={user.github} className="d-inline-block">
                                    <i class="bi bi-github text-primary pr-2"></i>
                                    Github
                                </a>
                            </li> : null
                    }
                    {
                        user?.yt ?
                            <li className="pl-3 border py-2 rounded">
                                <a href={user.yt} className="d-inline-block">
                                    <i class="bi bi-youtube text-primary pr-2"></i>
                                    Youtube
                                </a>
                            </li> : null
                    }
                    {
                        user?.vimeo ?
                            <li className="pl-3 border py-2 rounded">
                                <a href={user.vimeo} className="d-inline-block">
                                    <i class="bi bi-vimeo text-primary pr-2"></i>
                                    Vimeo
                                </a>
                            </li> : null
                    }
