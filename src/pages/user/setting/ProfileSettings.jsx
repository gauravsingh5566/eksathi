                                ...
                                <div className="d-flex justify-content-between">
                                    <div className="">
                                        <div className="hero-content d-flex align-items-center">
                                            ...
                                            <h2 className="section-title fs-30">Profile Settings</h2>
                                        </div>
                                        {/* end hero-content */}
                                    </div>
                                    {/* end col-lg-8 */}
                                    <div className="">
                                        <div className="hero-btn-box text-right py-3">
                                            ...
                                            >
                                                <i className="la la-gear mr-1" /> View Profile
                                            </Button>
                                            <Button variant="soft" color="neutral"
                                                onClick={() => navigate('/setting/account')}

                                            >
                                                <i className="la la-gear mr-1" /> Account Settings
                                            </Button>
                                        </div>
                                    </div>
                                    {/* end col-lg-4 */}
                ...
                >
                  Delete Account
                                    ...
                                    <li className="nav-item">
                                        <NavLink
                                            className="nav-link btn btn-link"
                                            to={"/setting/profile/academic-profile"}
                                        >
                                            Academic Profile
                                        </NavLink>
                                    </li>
                                    {
                                        profession === 'teacher' || profession === 'professional' ?
                                            <li className="nav-item">
                                                <NavLink
                                                    className="nav-link btn btn-link"
                                                    to={"/setting/profile/job-profile"}
                                                >
